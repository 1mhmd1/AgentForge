...
OUTPUT_DIR = "output"
DOMAIN = "web_research"
GOAL = "Research UFC card today and summarize main fight"
COMPLEXITY = "simple"
...
# ── Research Content ─────────────────────────────────────
RESEARCH_CONTENT = """<html><head><title>UFC Card Today</title></head><body><h1>UFC Card Today</h1><p>Check the official UFC website for the latest card information.</p><p>However, based on my research, here is a summary of the main fight:</p><p>Unfortunately, I couldn't find the latest information on the main fight. Please check the official UFC website for the latest updates.</p></body></html>
<html><head><title>UFC Card Today</title></head><body><h1>UFC Card Today</h1><p>Check the official UFC website for the latest card information.</p><p>However, based on my research, here is a summary of the main fight:</p><p>Unfortunately, I couldn't find the latest information on the main fight. Please check the official UFC website for the latest updates.</p></body></html>"""
