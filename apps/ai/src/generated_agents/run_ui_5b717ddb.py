...
OUTPUT_DIR = "output"
DOMAIN = "web_research"
GOAL = "Research the latest ai models used"
COMPLEXITY = "simple"
...
# ── Research Content ─────────────────────────────────────
RESEARCH_CONTENT = """<html><body><h1>Latest AI Models</h1><ul><li>Transformers</li><li>Generative Adversarial Networks (GANs)</li><li>Reinforcement Learning</li><li>Deep Learning</li></ul></body></html>
<html><body><h1>Latest AI Models</h1><ul><li>Transformers</li><li>Generative Adversarial Networks (GANs)</li><li>Reinforcement Learning</li><li>Deep Learning</li></ul></body></html>"""
