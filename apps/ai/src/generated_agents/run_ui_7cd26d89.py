...
COMPLEXITY       = "medium"
SUCCESS_CRITERIA = "Complete technical report"
STEPS            = ["Research cloud architecture best practices", "Summarize findings into a report"]
...
def execute_step_1():
    ...
    Research cloud architecture best practices
    """
...
def run() -> None:
    ...
    try:
        ...
        print(f"[Step 1] Research cloud architecture best practices")
        step_results["step_1"] = execute_step_1()
        
        print(f"[Step 2] Summarize findings into a report")
