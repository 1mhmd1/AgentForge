...
OUTPUT_DIR = "output"
DOMAIN = "web_research"
GOAL = "Research UFC 2026 and summarize top 3"
COMPLEXITY = "simple"
...
result = requests.get('https://www.ufc.com/event/ufc-2026').text
print(result)
import requests
results = requests.get('https://en.wikipedia.org/wiki/UFC_2026').text
print(results)"""
