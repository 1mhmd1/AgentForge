...
OUTPUT_DIR = "output"
DOMAIN = "web_research"
GOAL = "Research AI trends and summarize top 5"
COMPLEXITY = "simple"
...
print('AI trends research started')
import json
print(json.dumps({'top_5': ['AI trend 1', 'AI trend 2', 'AI trend 3', 'AI trend 4', 'AI trend 5']}))"""
