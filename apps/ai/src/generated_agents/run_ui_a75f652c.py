...
OUTPUT_DIR = "output"
DOMAIN = "web_research"
GOAL = "Research the latest models used and summarize the top 8"
COMPLEXITY = "simple"
...
# ── Research Content ─────────────────────────────────────
RESEARCH_CONTENT = """<html><body><h1>Latest AI Models</h1><ul><li>Transformers</li><li>BERT</li><li>RoBERTa</li><li>XLNet</li><li>ALBERT</li><li>DALL-E</li><li>CLIP</li><li>PaLM</li></ul></body></html>
<html><body><h1>Latest AI Models</h1><ul><li>Transformers</li><li>BERT</li><li>RoBERTa</li><li>XLNet</li><li>ALBERT</li><li>DALL-E</li><li>CLIP</li><li>PaLM</li></ul></body></html>"""
